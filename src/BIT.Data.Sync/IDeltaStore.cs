...
namespace BIT.Data.Sync
{
    ...
    public interface IDeltaStore
    {
        ...
        Task PurgeDeltaStoreAsync(CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<IEnumerable<IDelta>> GetDeltasFromOtherClients(string startIndex, string myIdentity, CancellationToken cancellationToken);
        /// <summary>
