...
namespace BIT.Data.Sync
{
    public interface IDeltaStore
    {
        ...
        /// <param name="cancellationToken">a cancellation token</param>
        /// <returns>An IEnumerable of deltas</returns>
        Task<IEnumerable<IDelta>> GetDeltasByIdentityAsync(Guid startindex, string identity, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<int> GetDeltaCountAsync(Guid startindex, string identity, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<Guid> GetLastProcessedDeltaAsync(string identity, CancellationToken cancellationToken);
        /// <summary>
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>An empty task</returns>
        Task SetLastProcessedDeltaAsync(Guid Index, string identity, CancellationToken cancellationToken);
        /// <summary>
        ...
        Task<Guid> GetLastPushedDeltaAsync(string identity, CancellationToken cancellationToken);
        /// <summary>
        ...
        /// <param name="cancellationToken">A cancellation token</param>
        /// <returns>An empty task</returns>
        Task SetLastPushedDeltaAsync(Guid Index, string identity, CancellationToken cancellationToken);
        /// <summary>
