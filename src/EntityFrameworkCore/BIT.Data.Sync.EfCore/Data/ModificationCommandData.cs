...
namespace BIT.Data.Sync.EfCore.Data
{
    ...
    public class ModificationCommandData
    {
        ...
        public ModificationCommandData(List<Parameters> parameters, List<EfSqlCommandData> sqlCommandTexts, int AffectedRows)
        {
        ...
        public ModificationCommandData(IEnumerable<Parameters> parameters, IEnumerable<EfSqlCommandData> sqlCommandTexts, int AffectedRows)
        {
